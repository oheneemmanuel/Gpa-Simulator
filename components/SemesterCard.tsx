  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-50 dark:bg-yellow-50/70 border border-gray-200 dark:border-yellow-200/60 p-5 rounded-xl text-center shadow-sm">
          <span className="block text-[10px] font-bold text-gray-500 dark:text-yellow-700 uppercase tracking-wider">
            Total Combined Credits
          </span>
          <p className="text-4xl font-extrabold text-gray-800 dark:text-gray-900 mt-2">
            {totalCreditsCombined}
          </p>
        </div>
      </div>
